...
>
	<h3
		class="cbc-chatbot__subtitulo cbc-chatbot__titulo-precios"
	>
		Precios
	</h3>

	<p class="cbc-chatbot__texto-precios">
		Cada tratamiento se adapta a las necesidades de cada persona.
	</p>

	<div class="cbc-chatbot__informacion cbc-chatbot__informacion--precios">

		<div
			class="cbc-chatbot__icono-precios"
			aria-hidden="true"
		>
			<svg
				width="24"
	...
	<div class="cbc-chatbot__acciones-contacto">
		...
		<button
			type="button"
			class="cbc-chatbot__opcion cbc-chatbot__opcion--destacada cbc-chatbot__boton-valoracion-precios"
		>
			<svg
			...
			<span class="cbc-chatbot__texto-valoracion-precios">
		...
		<a
			...
			aria-label="Consultar precios por WhatsApp"
		>
			<svg
				class="cbc-chatbot__icono-contacto"
				width="20"
			...
			<span class="cbc-chatbot__texto-whatsapp-precios">
		...
		>
			...
			<span class="cbc-chatbot__texto-llamar-precios">
				Llamar
			</span>
		</a>
