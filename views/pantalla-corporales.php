...
<div
	...
	data-pantalla="corporales"
	hidden
>
	<h3 class="cbc-chatbot__subtitulo cbc-chatbot__titulo-corporales">
		Tratamientos corporales
	</h3>

	<p class="cbc-chatbot__texto-corporales">
	...
	<div class="cbc-chatbot__acciones-secundarias">
		<button
			type="button"
			class="cbc-chatbot__opcion cbc-chatbot__opcion--destacada cbc-chatbot__boton-cita-corporales"
		>
			Pedir cita
		</button>
	</div>
